...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_dms" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4a2282e7#;
   pragma Export (C, u00001, "main_dmsB");
   ...
   u00159 : constant Version_32 := 16#1274f0e7#;
   pragma Export (C, u00159, "p_commandfuncsB");
   u00160 : constant Version_32 := 16#820af045#;
   pragma Export (C, u00160, "p_commandfuncsS");
   ...
   u00165 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00165, "system__img_realB");
   u00166 : constant Version_32 := 16#f508d0da#;
   pragma Export (C, u00166, "system__img_realS");
   u00167 : constant Version_32 := 16#36373acb#;
   ...
   u00170 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00170, "system__img_lluB");
   u00171 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00171, "system__img_lluS");
   u00172 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00172, "system__powten_tableS");
   u00173 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00173, "system__val_realB");
   u00174 : constant Version_32 := 16#3cdf6ded#;
   pragma Export (C, u00174, "system__val_realS");
   u00175 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00175, "system__exn_llfB");
   u00176 : constant Version_32 := 16#8ede3ae4#;
   pragma Export (C, u00176, "system__exn_llfS");
   u00177 : constant Version_32 := 16#6ad59d2c#;
   pragma Export (C, u00177, "system__fat_fltS");
   u00178 : constant Version_32 := 16#9cadf8d1#;
   pragma Export (C, u00178, "p_datastruct_treeB");
   u00179 : constant Version_32 := 16#db557246#;
   pragma Export (C, u00179, "p_datastruct_treeS");
   u00180 : constant Version_32 := 16#d0475a91#;
   pragma Export (C, u00180, "p_gen_doublelinkedlistB");
   u00181 : constant Version_32 := 16#40ad53b5#;
   pragma Export (C, u00181, "p_gen_doublelinkedlistS");
   u00182 : constant Version_32 := 16#8d43c8f6#;
   pragma Export (C, u00182, "p_metadataB");
   u00183 : constant Version_32 := 16#5f806925#;
   pragma Export (C, u00183, "p_metadataS");
   ...
   u00192 : constant Version_32 := 16#5b5afe46#;
   pragma Export (C, u00192, "p_dmsB");
   u00193 : constant Version_32 := 16#44c92fe6#;
   pragma Export (C, u00193, "p_dmsS");
