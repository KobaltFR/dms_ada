...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testdll" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#aff81121#;
   pragma Export (C, u00001, "testdllB");
   ...
   u00134 : constant Version_32 := 16#0eff2639#;
   pragma Export (C, u00134, "p_gen_doublelinkedlistB");
   u00135 : constant Version_32 := 16#440769f6#;
